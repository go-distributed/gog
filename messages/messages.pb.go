...
func (this *ForwardJoin) String() string {
	...
	s := strings.Join([]string{`&ForwardJoin{`,
		`Uuid:` + valueToStringMessages(this.Uuid) + `,`,
		`Ttl:` + valueToStringMessages(this.Ttl) + `,`,
		`XXX_unrecognized:` + fmt.Sprintf("%v", this.XXX_unrecognized) + `,`,
		`}`,
	}, "")
	return s
...
func NewPopulatedUserMessage(r randyMessages, easy bool) *UserMessage {
	this := &UserMessage{}
	v1 := r.Intn(100)
...
func NewPopulatedJoin(r randyMessages, easy bool) *Join {
	this := &Join{}
	v4 := r.Intn(100)
...
func NewPopulatedForwardJoin(r randyMessages, easy bool) *ForwardJoin {
	this := &ForwardJoin{}
	v5 := r.Intn(100)
...
func NewPopulatedDisconnect(r randyMessages, easy bool) *Disconnect {
	this := &Disconnect{}
	v7 := r.Intn(100)
...
func NewPopulatedShuffle(r randyMessages, easy bool) *Shuffle {
	this := &Shuffle{}
	v8 := r.Intn(100)
...
func NewPopulatedShuffleReply(r randyMessages, easy bool) *ShuffleReply {
	this := &ShuffleReply{}
	v11 := r.Intn(100)
...
func randFieldMessages(data []byte, r randyMessages, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		data = encodeVarintPopulateMessages(data, uint64(v15))
	case 1:
		data = encodeVarintPopulateMessages(data, uint64(key))
...
func (this *UserMessage) GoString() string {
	...
	s := strings1.Join([]string{`&protobuf.UserMessage{` + `Uuid:` + valueToGoStringMessages(this.Uuid, "byte"), `Payload:` + fmt1.Sprintf("%#v", this.Payload), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *Join) GoString() string {
	...
	s := strings1.Join([]string{`&protobuf.Join{` + `Uuid:` + valueToGoStringMessages(this.Uuid, "byte"), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *ForwardJoin) GoString() string {
	...
	s := strings1.Join([]string{`&protobuf.ForwardJoin{` + `Uuid:` + valueToGoStringMessages(this.Uuid, "byte"), `Ttl:` + valueToGoStringMessages(this.Ttl, "uint32"), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *Disconnect) GoString() string {
	...
	s := strings1.Join([]string{`&protobuf.Disconnect{` + `Uuid:` + valueToGoStringMessages(this.Uuid, "byte"), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *Shuffle) GoString() string {
	...
	s := strings1.Join([]string{`&protobuf.Shuffle{` + `Uuid:` + valueToGoStringMessages(this.Uuid, "byte"), `Candidates:` + fmt1.Sprintf("%#v", this.Candidates), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *ShuffleReply) GoString() string {
	...
	s := strings1.Join([]string{`&protobuf.ShuffleReply{` + `Uuid:` + valueToGoStringMessages(this.Uuid, "byte"), `Candidates:` + fmt1.Sprintf("%#v", this.Candidates), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
...
func extensionToGoStringMessages(e map[int32]code_google_com_p_gogoprotobuf_proto1.Extension) string {
	if e == nil {
		return "nil"
	}
